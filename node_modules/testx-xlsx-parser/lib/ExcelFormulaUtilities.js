 ...
 */
    ...
    excelFormulaUtilities.isEu = typeof isEu === 'boolean' ? isEu : false;
    ...
    /**
  	...
  	* </code>
  	*
      * @memberOf excelFormulaUtilities.core
  	* @function
      * @param {String} inStr
      **/
  	var formatStr = function(inStr) {
    ...
    function getTokens(formula) {
        ...
        while (!EOF()) {
            ...
            if (currentChar() === "," && !excelFormulaUtilities.isEu) {
                if (token.length > 0) {
                    tokens.add(token, TOK_TYPE_OPERAND);
                    token = "";
                }
...
module.exports = excelFormulaUtilities
